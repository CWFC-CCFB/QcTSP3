...
test_that("Testing nb rows in sites", {expect_equal(nrow(QcTSP3Data$sites), 101742)})
...
test_that("Testing nb rows in selectedTrees", {expect_equal(nrow(selectedTrees), 37)})
